export default {
  translation: {
    ...
    boostHub: {
      ...
      description1:
        'Boost Hub es más que solo un editor de Markdown o de Wiki.',
      description2:
      ...
      feature3Name: 'Hermoso Script Matemático',
      feature3Detail:
        'Para una declaración limpia de ecuaciones matemáticas es hora de usar LaTex en el editor de Boost Hub.',
    },
    features: {
      ...
      mathEquations: 'Ecuaciones Matemáticas',
      mathEquationsDescription:
        'Boost Note soporta bloques matemáticos. En los bloques, puedes escribir con sintaxis de LaTeX.',
      customizableTheme: 'Tema Personalizable',
      customizableThemeDescription:
        'Puedes personalizar el estilo de la interfaz tu aplicación, su editor y el contenido del Markdown renderizado.',
    ...
    pricing: {
      ...
      basic: 'Básico',
      premium: 'Premium',
      sync: 'Sincronizando múltiples dispositivos',
