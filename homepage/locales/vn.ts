  ...
  translation: {
    ...
    features: {
      ...
      cloudStorageDescription:
        'Mọi ghi chú sẽ được lưu trữ an toàn trên đám mây và có thể truy cập trên mọi thiết bị.',
      ...
      extensibleMarkdownDescription:
        'Bạn có thể thêm những cú pháp Markdown của riêng bạn và tuỳ chỉnh chúng được hiển thị như thế nào.',
    },
    pricing: {
      title: 'Gói dịch vụ',
      feature: 'Chức năng',
      ...
      free: 'Miễn phí',
      month: 'Tháng',
      furtherPlan: 'Sau đó, $5 (USD) cho mỗi 5GB.',
    },
    download: {
    ...
    community: {
      title: 'Tham gia cộng đồng chúng tôi',
      description:
        'Chúng tôi có công đồng lập trình viên lớn mạnh đằng sau Boostnote. Cộng đồng chúng tôi có được rất nhiều sự chú ý trên Github và được hỗ trợ bởi đông đảo lập trình viên khác trên hơn 200 quốc gia và vùng lãnh thổ. Chúng tôi luôn luôn hoan nghênh bạn. Hãy tham gia cũng chúng tôi!',
    },
    footer: {
      mission: 'Sứ mệnh',
      pressKit: 'Press Kit',
