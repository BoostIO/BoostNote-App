...
function loadPreviewStyle() {
  // function loadPreviewStyle(theme: ThemeTypes) {
  const previewStyle = localLiteStorage.getItem(previewStyleKey)
  if (previewStyle == null) {
    // return defaultPreviewStyle({ theme: selectV2Theme(theme) })
    return defaultCustomizablePreviewStyle
  }
  return previewStyle
}
...
function usePreviewStyleStore() {
  ...
  // loadPreviewStyle(settings['general.theme'])
  // )
