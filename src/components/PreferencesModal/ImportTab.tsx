...
const ImportTab = () => {
  return (
    <div>
      <p>
        Importing from the legacy app will be implemented along with File System
        based storage before the end of June 2020.
      </p>

      <p>Until it is ready, please keep using the old app.</p>
    </div>
  )
}
