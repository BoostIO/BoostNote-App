...
const frTranslation: TranslationSource = {
  //General
  [lngKeys.GeneralError]: 'خطا',
  [lngKeys.GeneralCreate]: 'ایجاد',
  [lngKeys.GeneralCancel]: 'لغو',
  [lngKeys.GeneralUpdate]: 'به روز رسانی',
  [lngKeys.GeneralAttachments]: 'ضمیمه',
  [lngKeys.GeneralArchive]: 'اضافه کردن به آرشیو',
  [lngKeys.GeneralSignin]: 'اتصال',
  [lngKeys.GeneralSigningIn]: 'در حال اتصال',
  [lngKeys.GeneralSignout]: 'قطع ارتباط',
  [lngKeys.GeneralSave]: 'ذخیره',
  [lngKeys.GeneralDefault]: 'پیش فرض',
  [lngKeys.GeneralDelete]: 'حذف',
  [lngKeys.GeneralDaily]: 'روزانه',
  [lngKeys.GeneralWeekly]: 'هفتگی',
  [lngKeys.GeneralNever]: 'هرگز',
  [lngKeys.GeneralTemplates]: 'قالب ها',
  [lngKeys.GeneralTitle]: 'عنوان',
  [lngKeys.GeneralUse]: 'کاربرد',
  [lngKeys.GeneralChangeIcon]: "تغییر آیکون",
  [lngKeys.GeneralFolders]: 'پوشه ها',
  [lngKeys.GeneralShowMore]: 'بیشتر',

  // settings
  [lngKeys.SettingsInfo]: 'پروفایل من',
  [lngKeys.SettingsGeneral]: 'تنظیمات من',
  [lngKeys.SettingsNotifications]: 'اعلان ایمیل',
  [lngKeys.SettingsTeamInfo]: 'تنظیمات',
  [lngKeys.SettingsTitle]: 'تنظیمات',
  [lngKeys.SettingsPersonalInfo]: 'تنظیمات',
  [lngKeys.SettingsPreferences]: 'تنظیمات',
  [lngKeys.SettingsTeamUpgrade]: 'به روز رسانی',
  ...
  [lngKeys.SettingsAppFeedback]: 'فیس بوک',
  ...
  [lngKeys.TeamName]: "نام گروه",
  [lngKeys.TeamDomain]: "Domaine de l'équipe",
  [lngKeys.SpaceName]: "نام فضا",
  ...
  [lngKeys.InviteEmail]: 'دعوت از طریق ایمیل',
  ...
  [lngKeys.CommunityBugReport]: 'گزارش خرابی',
