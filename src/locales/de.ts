export default {
  translation: {
    ...
    'note.delete': 'Löschen',
    'note.delete2': 'Notiz löschen',
    'note.deleteMessage': 'Die Notiz wird endgültig gelöscht',
    'note.empty': 'Leere Notiz',
    'note.unselect': 'Keine Notiz ausgewählt',
    'note.search': 'Notizen durchsuchen',
    ...
    'about.facebook': 'Facebook Gruppe',
    'about.reddit': 'Reddit',
    ...
    // Preferences
    'preferences.general': 'Einstellungen',
    ...
    'preferences.noteSorting': 'Notiz-Sortierung',
    ...
    'preferences.tab': 'Tab',
    'preferences.spaces': 'Leerzeichen',
